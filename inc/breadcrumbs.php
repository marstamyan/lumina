	...
	function get_crumbs( $sep, $l10n, $args ) {
		...
		if ( 1 ) {
			...
			elseif ( $mark === 'rdf.data-vocabulary.org' )
				$mark = array(
					'wrappatt' => '<ul class="breadcrumbs-list" prefix="v: http://rdf.data-vocabulary.org/#">%s</ul>',
					'linkpatt' => '<li typeof="v:Breadcrumb"><a href="%s" rel="v:url" property="v:title">%s</a>',
					'sep_after' => '</li>',
				);
			elseif ( $mark === 'schema.org' )
				$mark = array(
					'wrappatt' => '<ul class="breadcrumbs-list" itemscope itemtype="http://schema.org/BreadcrumbList">%s</ul>',
					'linkpatt' => '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="%s" itemprop="item"><span class="brdc_link" itemprop="name">%s</span></a></li>',
					'sep_after' => '',
				);
